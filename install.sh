...
echo "-- installazione di  virtual host discovery"
...
#installazione di knock, script in python per l'enumerazione di subdomini
echo "-- installazione di knock.py"
git clone https://github.com/guelfoweb/knock.git
cd ~/tools/
echo "-- Operazione Eseguita"
sleep 2

#installazione di lazy, script in bash che automatizza info gathering e recon.
...
#installazione di crtndstry, script in bash per enumerazione di subdomains
echo "-- installazione di crtndstry"
